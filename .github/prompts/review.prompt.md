...
>
> - コードの実装・修正は行わないでください
> - `docs/<identifier>/` 配下のドキュメントを検索し、見つかったものを元にレビューを実施してください
...
| ドキュメント       | 確認観点                         |
| ------------------ | -------------------------------- |
| `requirement.md`   | 機能要件・非機能要件との整合性   |
| `design-detail.md` | 設計通りの実装か                 |
| `tasks.md`         | タスクごとの完了条件を満たすか   |
| `usecase-*.md`     | 各タスクの受け入れ条件を満たすか |
